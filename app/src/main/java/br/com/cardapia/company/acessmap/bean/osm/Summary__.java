...
public class Summary__ implements Serializable
{
    ...
    private final static long serialVersionUID = -3224637855205534121L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Summary__) == false) {
            return false;
        }
        Summary__ rhs = ((Summary__) other);
