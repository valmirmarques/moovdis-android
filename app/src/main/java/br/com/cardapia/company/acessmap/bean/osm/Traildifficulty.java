...
public class Traildifficulty implements Serializable
{
    ...
    private List<Summary__> summary = null;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();
    private final static long serialVersionUID = -756271531375438459L;
    ...
    @JsonProperty("summary")
    public List<Summary__> getSummary() {
        return summary;
    }

    @JsonProperty("summary")
    public void setSummary(List<Summary__> summary) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Traildifficulty) == false) {
            return false;
        }
        Traildifficulty rhs = ((Traildifficulty) other);
