...
/**
 * Created by tvtios-01 on 04/02/18.
 */
...
public class ShareUtils {
    ...
    public static final int SHARE_ROUTE_CODE = 545;
    ...
    public static void shareTwitter(Activity activity, String text, String url, String via, String hashtags) {
        ...
        activity.startActivityForResult(intent, SHARE_ROUTE_CODE);
    }
    ...
    public static void shareWhatsapp(Activity activity, String text, String url) {
        ...
        try {
            ...
            activity.startActivityForResult(Intent
                    .createChooser(waIntent, activity.getString(R.string.share_intent_title)), SHARE_ROUTE_CODE);

        } catch (PackageManager.NameNotFoundException e) {
            Toast.makeText(activity, activity.getString(R.string.app_not_instaled),
